...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col items-center pt-10 md:pt-16 pb-32 min-h-screen bg-black text-white selection:bg-[#b87209] selection:text-black font-sans">
      {/* 1. HERO SECTION */}
        ...
        {isRedirecting ? (
          ...
          <div className="space-y-4">
            <div className="relative">
              <Wallet>
                <ConnectWallet className="w-full bg-white text-black font-black py-4 uppercase tracking-tighter flex items-center justify-center space-x-3 hover:bg-gray-200 transition-all shadow-lg group rounded-none border-none">
            ...
            <p className="text-center text-gray-500 text-[10px] uppercase tracking-tighter font-bold">
              Sign in with your Base wallet to continue
            </p>
          </div>
        )}
      </div>
